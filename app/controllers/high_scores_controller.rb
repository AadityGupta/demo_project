  ...
  def create
    ...
    respond_to do |format|
      if @high_score.save
		...
		format.html { redirect_to edit_high_score_path(@high_score), notice: 'High score was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @high_score.update_attributes(params[:high_score])
        format.html { redirect_to high_scores_path, notice: 'High score was successfully updated.' }
